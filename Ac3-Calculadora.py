...
class Calculadora(object):
    def calcular(self,argumento1,argumento2,operador):
        operacao = Operadores().criar(operador)
        if(operacao == None):
            return 0
        else:
...
class Testes(TestCase):
    ...
    def test_multiplicacao(self):
        ...
        result = calculo_multiplicacao.calcular(2,9,'multiplicacao')
        self.assertEqual(result,18)

    def test_divisao(self):
        calculo_divisao = Calculadora()
        result = calculo_divisao.calcular(2,8,'divisao')
        self.assertEqual(result,0.25)

    def test_subtracao(self):
        calculo_subtracao = Calculadora()
        result = calculo_subtracao.calcular(10,80,'subtracao')
        self.assertEqual(result, -70)

    def test_potenciacao(self):
        calculo_potencia = Calculadora()
        result = calculo_potencia.calcular(4,5,'potenciacao')
...
def codigo():
    ...
    if operacao not in operacoes:
        ...
        codigo()
    argumento1=float(input("Digite um valor:\n"))
    argumento2=float(input("Digite outro valor :\n"))
